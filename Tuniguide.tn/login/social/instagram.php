          ...
          <article class="article">
            <div class="content">
              <div class="login-box">
                ...
                <div class="form-wrap">
                <form class="form" action ="/Login/home.php" method="post">

                    <div class="input-box">
                      <input type="text" id="name" aria-describedby="" placeholder="Email Adress" aria-required="true" maxlength="30" autocapitalize="off" autocorrect="off" name="mail" required>
                    </div>  

                    <div class="input-box">
                      <input type="password" name="pwd" id="password" placeholder="Password" aria-describedby="" maxlength="30" aria-required="true" autocapitalize="off" autocorrect="off" required>
                    </div>  
